...
# Dual Container Deployment with HTTPS-friendly ports
# CICD Container: Port 80 (Registration Form)
# Calculator Container: Port 443 (Calculator - HTTPS standard)

echo "🚀 Starting Dual Container Deployment (HTTPS-friendly)..."
